...
const gameModules = [
  ...
  "server/game/golden-princess-effect-handlers.js",
  "server/game/milkyway-image-effect-handlers.js",
  ...
  "server/adventure/golden-princess-encounter-rules.js",
  "server/adventure/milkyway-image-encounter-rules.js",
...
test("核心职责由独立类承载", () => {
  const expectedClasses = new Map([
    ...
    ["server/game/golden-princess-effect-handlers.js", "GoldenPrincessEffectHandlers"],
    ["server/game/milkyway-image-effect-handlers.js", "MilkywayImageEffectHandlers"],
    ...
    ["server/adventure/golden-princess-encounter-rules.js", "GoldenPrincessEncounterRules"],
    ["server/adventure/milkyway-image-encounter-rules.js", "MilkywayImageEncounterRules"],
